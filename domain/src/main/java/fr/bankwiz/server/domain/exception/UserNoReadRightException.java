...
public class UserNoReadRightException extends FunctionalException {
    ...
    public UserNoReadRightException(final UserDomain user, final GroupDomain group) {
        super(MessageFormat.format("The user {0} have no read right of group {1}", user.getId(), group.getId()));
